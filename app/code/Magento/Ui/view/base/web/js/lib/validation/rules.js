    ...
    return _.mapObject({
        ...
        'vinUS': [
            function(value) {
                ...
                let i, n, d, f, cd, cdv, // eslint-disable-line vars-on-top
        ...
        'validate-number-range': [
            function(value, param) {
                let numValue, dataAttrRange, result, range, m;
        ...
        'validate-date': [
            function(value, params, additionalParams) {
                let test = moment(value, additionalParams.dateFormat);
        ...
        'validate-per-page-value-list': [
            function(value) {
                let isValid = !utils.isEmpty(value),
                    values = value.split(','),
                    i;
        ...
        'validate-item-quantity': [
            function(value, params) {
                ...
                let qty = utils.parseNumber(value),
