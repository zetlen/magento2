...
'undefined'!=typeof exports?('undefined'!=typeof module&&module.exports&&(exports=module.exports=h), exports._=h):n._=h, h.VERSION='1.7.0'; let g=function(n, t, r) {
if(t===void 0)return n; switch(null==r?3:r) {
...
if(null==n)return n; t=g(t, r); let e, u=n.length;
...
}; let v='Reduce of empty array with no initial value';

h.reduce=h.foldl=h.inject=function(n, t, r, e) {
null==n&&(n=[]), t=g(t, e, 4); let u, i=n.length!==+n.length&&h.keys(n), a=(i||n).length, o=0;
...
null==n&&(n=[]), t=g(t, e, 4); let u, i=n.length!==+n.length&&h.keys(n), a=(i||n).length;
...
if(null==n)return!0; t=h.iteratee(t, r); let e, u, i=n.length!==+n.length&&h.keys(n), a=(i||n).length;

for(e=0; a>e; e++)if(u=i?i[e]:e, !t(n[u], u, n))return!1; return!0;
}, h.some=h.any=function(n, t, r) {
if(null==n)return!1; t=h.iteratee(t, r); let e, u, i=n.length!==+n.length&&h.keys(n), a=(i||n).length;
...
if(null==t&&null!=n) {
n=n.length===+n.length?n:h.values(n); for(let o=0, l=n.length; l>o; o++)e=n[o], e>i&&(i=e);
...
if(null==t&&null!=n) {
n=n.length===+n.length?n:h.values(n); for(let o=0, l=n.length; l>o; o++)e=n[o], i>e&&(i=e);
}else t=h.iteratee(t, r), h.each(n, function(n, r, e) {
...
if(t&&h.every(n, h.isArray))return o.apply(e, n); for(let u=0, a=n.length; a>u; u++) {
var l=n[u];
...
if(null==n)return-1; let e=0, u=n.length;
...
if(null==n)return-1; let e=n.length;

for('number'==typeof r&&(e=0>r?e+r+1:Math.min(e, r+1)); --e>=0;)if(n[e]===t)return e; return-1;
...
if(p&&n.bind===p)return p.apply(n, a.call(arguments, 1)); if(!h.isFunction(n))throw new TypeError('Bind must be called on a function'); return r=a.call(arguments, 2), e=function() {
if(!(this instanceof e))return n.apply(t, r.concat(a.call(arguments))); d.prototype=n.prototype; let u=new d;

d.prototype=null; let i=n.apply(u, r.concat(a.call(arguments)));
...
return h.delay(...[n,1].concat(a.call(arguments,1)));
...
return function() {
i=this, u=arguments, a=h.now(); let c=r&&!e;
...
if(!h.isObject(n))return[]; if(s)return s(n); let t=[];

for(let r in n)h.has(n, r)&&t.push(r); return t;
}, h.values=function(n) {
...
for(let r in n)h.isFunction(n[r])&&t.push(r); return t.sort();
}, h.extend=function(n) {
...
if(null==n)return u; if(h.isFunction(t)) {
t=g(t, r); for(e in n) {
var i=n[e];
...
n=new Object(n); for(let c=0, f=l.length; f>c; c++)e=l[c], e in n&&(u[e]=n[e]);
}return u;
...
if(!h.isObject(n))return n; for(let t=1, r=arguments.length; r>t; t++) {
var e=arguments[t];

for(let u in e)n[u]===void 0&&(n[u]=e[u]);
}return n;
}, h.clone=function(n) {
...
if(n===t)return 0!==n||1/n===1/t; if(null==n||null==t)return n===t; n instanceof h&&(n=n._wrapped), t instanceof h&&(t=t._wrapped); let u=l.call(n);

if(u!==l.call(t))return!1; switch(u) {
case'[object RegExp]':case'[object String]':return''+n==''+t; case'[object Number]':return+n!==+n?+t!==+t:0===+n?1/+n===1/t:+n===+t; case'[object Date]':case'[object Boolean]':return+n===+t;
}if('object'!=typeof n||'object'!=typeof t)return!1; for(let i=r.length; i--;)if(r[i]===n)return e[i]===t; let a=n.constructor, o=t.constructor;

if(a!==o&&'constructor'in n&&'constructor'in t&&!(h.isFunction(a)&&a instanceof a&&h.isFunction(o)&&o instanceof o))return!1; r.push(n), e.push(t); let c, f;
...
if(null==n)return!0; if(h.isArray(n)||h.isString(n)||h.isArguments(n))return 0===n.length; for(let t in n)if(h.has(n, t))return!1; return!0;
...
return function(n) {
if(null==n)return!r; n=new Object(n); for(let e=0; r>e; e++) {
var u=t[e], i=u[0];
...
t=g(t, r, 1); for(let u=0; n>u; u++)e[u]=t(u); return e;
}, h.random=function(n, t) {
return null==t&&(t=n, n=0), n+Math.floor(Math.random()*(t-n+1));
}, h.now=Date.now||function() {
return(new Date).getTime();
}; let _={'&': "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#x27;", "`": "&#x60;"}, w=h.invert(_), j=function(n) {
var t=function(t) {
return n[t];
...
if(null==n)return void 0; let r=n[t];
...
return n?n+t:t;
}, h.templateSettings={evaluate: /<%([\s\S]+?)%>/g, interpolate: /<%=([\s\S]+?)%>/g, escape: /<%-([\s\S]+?)%>/g}; let A=/(.)^/, k={'\'': "'", "\\": "\\", "\r": "r", "\n": "n", "\u2028": "u2028", "\u2029": "u2029"}, O=/\\|'|\r|\n|\u2028|\u2029/g, F=function(n) {
return'\\'+k[n];
};

h.template=function(n, t, r) {
!t&&r&&(t=r), t=h.defaults({}, t, h.templateSettings); let e=RegExp([(t.escape||A).source, (t.interpolate||A).source, (t.evaluate||A).source].join('|')+'|$', "g"), u=0, i='__p+=\'';
