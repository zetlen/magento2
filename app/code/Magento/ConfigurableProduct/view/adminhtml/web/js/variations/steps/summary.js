...
define([
    ...
    return Component.extend({
        ...
        calculate: function(variations, getSectionValue) {
            let productSku = this.variationsComponent().getProductValue('sku'),
            ...
            _.each(variations, function(options) {
                let product, images, sku, quantity, price, variation,
        ...
        generateGrid: function() {
            let pageExisting = this.pagingExisting.pageSize * this.pagingExisting.current,
        ...
        getColumnsName: function(attributes) {
            let columns = this.attributesName.slice(0);
