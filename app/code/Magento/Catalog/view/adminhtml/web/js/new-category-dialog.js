...
define([
    ...
    let clearParentCategory = function() {
    ...
    $.widget('mage.newCategoryDialog', {
        ...
        _create: function() {
            ...
            newCategoryForm.mage('validation', {
                ...
                let options = $(this).validation('option');
            ...
            this.element.modal({
                ...
                /** @inheritdoc */
                opened: function() {
                    let enteredName = $('#category_ids-suggest').val();
                ...
                /** @inheritdoc */
                closed: function() {
                    let validationOptions = newCategoryForm.validation('option');
